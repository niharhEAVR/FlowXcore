...
import { 
  ...
  ErrorView,
  LoadingView
} from "@/components/created-ui/entity-components";
import { useRemoveCredential, useSuspenseCredentials } from "../hooks/use-credentials"
import { useRouter } from "next/navigation";
import { useCredentialsParams } from "../hooks/use-credentials-params";
import { useEntitySearch } from "@/hooks/use-entity-search";
import type { Credential } from "@/generated/client";
import { CredentialType } from "@/generated/enums";
...
export const CredentialItem = ({
  ...
  const logo = credentialLogos[data.type] || "/ai.svg";
    ...
    <EntityItem
      ...
      image={
        <div className="size-8 flex items-center justify-center">
          <Image src={logo} alt={data.type} width={27} height={27} />
        </div>
      }
